...
def home(request):
    return render(request,'auth/home/home.html')
...
def edit_register_view(request):
    ...
    return render(request,'auth/register/edit_register.html',context)
...
def password_change(request):
    ...
    return render(request,'auth/changePassword/changePassword.html',context)


class PasswordReset(PasswordResetView):
    template_name = 'auth/changePassword/passwordReset.html'

class PasswordResetDone(PasswordResetDoneView):
    template_name = 'auth/changePassword/password_reset_done.html'

class PasswordResetConfirm(PasswordResetConfirmView):
    template_name = 'auth/changePassword/password_reset_confirm.html'

class PasswordResetComplete(PasswordResetCompleteView):
    template_name = 'auth/changePassword/password_reset_complete.html'
